...
export default function BlogFooter() {
  return (
    <div className='w-[97%] flex items-center justify-around'>
      <FontAwesomeIcon size='sm' icon={faThumbsUp} className='w-1/3 h-5 py-[11px] rounded-sm text-white hover:bg-gray-600/15 dark:hover:bg-white/10 cursor-pointer hover:scale-110 hover:drop-shadow-none drop-shadow-[0_0_1px_blue] hover:text-blue-700/80' />
