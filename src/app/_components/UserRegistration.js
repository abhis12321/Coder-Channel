...
export default function Page() {
    ...
    return (
        <form onSubmit={handleSubmit} className='text-white bg-gradient-to-r  from-gray-950/50 via-cyan-950/50 to-gray-950/70 dark:from-indigo-900 dark:via-cyan-950 dark:to-indigo-950 w-[95%] max-w-[750px] rounded-2xl py-7 flex flex-col gap-1 items-center justify-center' autoComplete='on'>
            <h1 className="hidden sm:block mx-auto mb-4 py-4 px-8 rounded-xl text-3xl font-bold bg-blue-950/50 dark:bg-teal-950 text-center w-fit shadow-[0_0_5px_white]">New Resistration</h1>
            <div className="flex flex-col xs:flex-row gap-1 xs:gap-3 w-[95%] max-w-[600px] font-mono">
                <input name='name' type="text" value={name} onChange={e => setName(e.target.value)} className='w-full xs:flex-1 font-semibold shadow-[0_0_3px_white] bg-slate-950/40 outline-none py-2 px-3 rounded-xl mx-auto text-center focus:text-cyan-700 focus:bg-slate-950/60 focus:ring-2 ring-cyan-500 placeholder:font-light placeholder:text-sm' placeholder='Enter your name' required />
            ...
            <input name='email' type="email" value={email} onChange={e => setEmail(e.target.value)} className='w-[95%] max-w-[600px] font-semibold shadow-[0_0_3px_white] bg-slate-950/40 outline-none py-2 px-3 rounded-xl mx-auto text-center focus:text-cyan-700 focus:bg-slate-950/60 focus:ring-2 ring-cyan-500 font-mono placeholder:font-light placeholder:text-sm' placeholder='Enter your email' required />
            ...
            {/* <input name='image' type="text" value={imgUrl} onChange={e => setImgUrl(e.target.value)} className='w-[95%] max-w-[600px] font-semibold shadow-[0_0_3px_white] bg-slate-950/40 outline-none py-2 px-3 rounded-xl mx-auto text-center focus:text-cyan-700 font-mono placehold6r:font-light p ring-cyan-500laceholder:text-sm' placeholder='Enter your image url' /> */}
