...
export default function Card({ getData, student }) {
  return (
    <div className='bg-gradient-to-r from-gray-500 via-gray-200 to-gray-500 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-4 px-4 h-[444px] w-[325px] shadow-[0_0_6px_black] dark:shadow-[0_0_10px_white] hover:shadow-[0_0_15px_red] rounded-lg flex flex-col justify-evenly items-center gap-3'>
      <div className="">
      ...
      <div className="flex justify-center items-center gap-8">
        ...
        <Link href={`/students`}><FontAwesomeIcon icon={faGithub} size='2x' className='hover:scale-110 text-gray-900 dark:text-gray-400'/></Link>
      </div>
      ...
      <div className="flex items-center justify-center">        
        ...
        <FontAwesomeIcon icon={faShareNodes} size='1x' className='text-gray-400 hover:drop-shadow-[0_0_2px_yellow] opacity-100 py-[2px] px-[50%] h-6 cursor-pointer  '/>
      </div>
    </div>
  )
}
