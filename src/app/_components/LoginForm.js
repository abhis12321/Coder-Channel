...
export default function LoginForm() {
  ...
  return (
    <div className="flex flex-col items-center gap-3 w-full">
      ...
      <form onSubmit={handleLogin} className='from-blue-50 to-blue-50 bg-gradient-to-b  dark:from-blue-900/50 dark:via-cyan-950/90 dark:to-blue-950/60 shadow-[0_0_10px_black] dark:shadow-[0_0_4px_white] w-[98%] max-w-[500px] py-4 px-5 rounded-2xl min-h-[280px] text-white flex flex-col gap-3 items-center justify-around' autoComplete='on'>

        <div className="bgslate-950/20 py-1 px-10 rounded-lg">
