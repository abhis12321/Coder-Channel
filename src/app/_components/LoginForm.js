  ...
  return (
    <form onSubmit={handleLogin} className='bg-gradient-to-br from-gray-500 via-lime-950/40 to-gray-500 dark:from-slate-900 dark:via-cyan-950 dark:to-slate-950 shadow-[0_0_10px_white] w-[98%] max-w-[700px] py-7 rounded-xl min-h-[280px] text-white flex flex-col gap-3 items-center justify-around' autoComplete='on'>
      ...
      <div className="bg-slate-950/20 py-2 px-10 rounded-lg">
        ...
        <p className="text-center text-sm font-mono text-yellow-400 font-semibold drop-shadow-[0_0_7px_white]">Login with your email-id</p>
      </div>

      <input type="email" value = {email} onChange={(e)=> setEmail(e.target.value)} className='bg-slate-950/40 dark:bg-slate-950 block p-2 rounded text-center w-[98%] max-w-[550px] shadow-[0_0_4px_white]' placeholder='email' name='email' required/>
      
      <input type="password" value = {password} onChange={(e)=> setPass(e.target.value)} className='bg-slate-950/40 dark:bg-slate-950 block p-2 rounded text-center w-[98%] max-w-[550px] shadow-[0_0_4px_white]' placeholder='password' name='password' required/>

      <div className="flex items-center justify-evenly w-[98%] max-w-[550px]" >
      ...
      <div className="w-[98%] max-w-[550px] flex justify-between pt-2">
