...
export default function Blogs({ blog }) {
  return (
    <div className='w-[98%] max-w-[700px] min-h-20 min-w-20 ring-1 ring-gray-500 dark:ring-green-800 bg-white dark:bg-green-800/10 hover:shadow-[0_0_5px_gray] rounded-lg py-1 px-3 xs:px-4 md:px-5 flex flex-col gap-1 justify-evenly items-center'>
      <Link href={`/students/${blog.writerId}`} className="w-full min-h-16 px-4 py-2 rounded-lg flex gap-5 items-center hover:bg-blue-600/10 hover:animate-pulse">
