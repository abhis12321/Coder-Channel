...
export default function Blogs({ blog }) {
  ...
  return (
    <div className='relative w-[98%] max-w-[700px] min-h-20 min-w-20 dark:ring-green-800 bg-white dark:bg-green-800/10 shadow-[0_0_2px_gray] hover:shadow-[0_0_5px_gray] rounded-lg py-1 px-3 xs:px-4 md:px-5 flex flex-col justify-between items-center pb-[2.1px]' id={blog._id}>
