...
export default function Blogs( { blog } ) {
  return (
    <div className='w-[98%] max-w-[700px] min-h-20 min-w-20 bg-white ring-gray-500 dark:bg-green-800/20 ring-1 dark:ring-green-800 rounded-lg pt-4 pb-2 px-3 xs:px-4 md:px-5 flex flex-col gap-2  justify-evenly items-center'>
      <div className="w-full font-mono font-medium text-gray-700 dark:text-white whitespace-pre-wrap">
        {blog.blog}
      </div>
