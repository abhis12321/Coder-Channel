...
export default function Blogs( { blog } ) {
    // console.log(blog);
  return (
    <div className='w-[98%] max-w-[600px] min-h-20 min-w-20 bg-green-800/15 ring-1 ring-green-800 rounded-lg pt-4 pb-1 px-3 ms:px-4 flex flex-col gap-3 justify-evenly items-center'>
