...
export default function NavBar() {
  ...
  return (
    <div className="sticky top-0 left-0 z-[100] w-full bg-gradient-to-b from-gray-600 to-gray-800 dark:from-blue-900 dark:to-blue-900 text-gray-50 font-semibold flex items-center justify-between h-16 py-2 px-[4%] xm:px-8 md:px-12 overflow-hidden">
