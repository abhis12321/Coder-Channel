...
export default function NavBar() {
  ...
  return (
    <div className="h-16 py-2 px-[4%] sm:px-8 md:px-10 lg:px-12 fixed top-0 left-0 z-[90] w-full bg-white dark:bg-blue-900 text-gray-500 dark:text-gray-50 font-semibold flex items-center justify-between shadow-[0_0_2px_gray] backdrop-blur-lg">
