...
export default function BlogImageForm({ image, setImage }) {
    const selectImage = (e) => {
    ...
    return (
        <div className='flex flex-col gap-1 items-center justify-center rounded-md'>
            <Image src={image ? image : "/img/profileImg.jpg"} alt='image' width={150} height={150} className='h-28 w-28 ring-1 ring-red-950 rounded-full bg-white shadow-[0_0_5px_black] dark:shadow-[0_0_5px_white]' />
