        ...
        {students &&
          <>
            <div className="w-full px-1 xm:px-8 md:px-12 mx-auto flex flex-col md:flex-row gap-1 md:gap-2 items-center justify-center self-start font-serif">
              <select name="sort-by" id="" className="w-full  max-w-[340px] md:w-fit flex-1 outline-none py-2 px-3 rounded-xl text-center bg-white dark:bg-slate-950 shadow-[0_0_10px_black] dark:shadow-[0_0_10px_white] focus:shadow-[0_0_10px_black_inset] dark:focus:shadow-[0_0_10px_white_inset] font-semibold font-mono" placeholder='pending' value={searchBy} onChange={(e) => setSearchBy(e.target.value)} >
              ...
              <input type="text" className="w-full max-w-[340px]  md:w-fit flex-1 outline-none text-gray-700 dark:text-white py-[6px] px-5 rounded-xl bg-white dark:bg-slate-950 shadow-[0_0_10px_black] dark:shadow-[0_0_10px_white] focus:shadow-[0_0_10px_black_inset] dark:focus:shadow-[0_0_10px_white_inset] font-semibold font-mono dark:placeholder:text-gray-400 placeholder:text-gray-500 text-center" value={search} onChange={e => setSearch((e.target.value).toLowerCase())} placeholder='type here to search...' />
            </div>
