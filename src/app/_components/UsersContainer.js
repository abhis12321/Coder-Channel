        ...
        {students &&
          <>
            <div className="w-full px-1 xm:px-8 md:px-12 mx-auto flex flex-col md:flex-row gap-1 md:gap-2 items-center justify-center self-start font-serif">
              <select name="sort-by" id="" className="w-full  max-w-[340px] md:w-fit flex-1 outline-none py-2 px-3 rounded-xl text-center bg-white dark:bg-sky-900/40 shadow-[0_0_2px_gray_inset] dark:shadow-[0_0_2px_white_inset] focus:shadow-[0_0_5px_gray_inset] focus:bg-sky-600/10 dark:focus:shadow-[0_0_5px_white_inset] font-semibold font-mono" placeholder='pending' value={searchBy} onChange={(e) => setSearchBy(e.target.value)} >
