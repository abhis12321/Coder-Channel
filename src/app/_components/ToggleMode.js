...
export default function ToggleMode() {
  ...
  return (
    <div className='group cursor-pointer *:rounded-full flex items-center justify-center h-8 w-8 mx-auto p-6 lg:p-[22px] my-2 lg:my-0 rounded-full lg:ml-2 hover:scale-110 hover:ring-2 ring-gray-200  hover:bg-slate-950/30 dark:hover:bg-gray-200/15' onClick={toggleMode}>
