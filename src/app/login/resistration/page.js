...
export default function Page() {
  ...
  return (
    <form onSubmit={handleSubmit} className='text-white relative top-3 bg-gradient-to-br from-gray-900 via-cyan-950 to-indigo-950 w-[95%] max-w-[900px] m-auto rounded-2xl py-8 flex flex-col gap-3 items-center justify-center' autoComplete='on'>
      ...
      <input name='name' type="text" value = {data.name} onChange={(e)=> dispatch({ip:"name" , value:e.target.value})} className='w-[95%] max-w-[600px] font-semibold shadow-[0_0_3px_white] bg-slate-950/50 outline-none py-2 px-3 rounded-xl mx-auto text-center focus:text-cyan-700' placeholder='Name' required/>
      <input name='university' type="text" value = {data.university} onChange={(e)=> dispatch({ip:"university" , value:e.target.value})} className='w-[95%] max-w-[600px] font-semibold shadow-[0_0_3px_white] bg-slate-950/50 outline-none py-2 px-3 rounded-xl mx-auto text-center focus:text-cyan-700' placeholder='University' required/>
      <input name='course' type="text" value = {data.course} onChange={(e)=> dispatch({ip:"course" , value:e.target.value})} className='w-[95%] max-w-[600px] font-semibold shadow-[0_0_3px_white] bg-slate-950/50 outline-none py-2 px-3 rounded-xl mx-auto text-center focus:text-cyan-700' placeholder='course' required/>
      <input name='branch' type="text" value = {data.branch} onChange={(e)=> dispatch({ip:"branch" , value:e.target.value})} className='w-[95%] max-w-[600px] font-semibold shadow-[0_0_3px_white] bg-slate-950/50 outline-none py-2 px-3 rounded-xl mx-auto text-center focus:text-cyan-700' placeholder='branch' required/>
      <input name='sem' type="Number" value = {data.semester} onChange={(e)=> dispatch({ip:"semester" , value:e.target.value})} className='w-[95%] max-w-[600px] font-semibold shadow-[0_0_3px_white] bg-slate-950/50 outline-none py-2 px-3 rounded-xl mx-auto text-center focus:text-cyan-700' placeholder='semester' required/>
