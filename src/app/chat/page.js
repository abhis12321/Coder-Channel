...
function Page() {
    ...
    return (
        <div className='h-[100%] relative max-w-[900px] mx-auto bg-gradient-to-r from-white to-white dark:from-slate-900 dark:via-cyan-950 dark:to-slate-900 dark:text-white rounded-lg pb-1 overflow-auto'  style={{minHeight:'calc(100vh - 4.5rem)'}}>
