    ...
    <>
      <div className="flex justify-evenly items-center py-5 flex-wrap gap-6 h-nav">
        <div className="w-full flex items-center justify-center self-start">
          <input type="text" className="w-[98%] max-w-[500px] outline-none ring-1 focus:ring-2 ring-violet-700 text-red-950 dark:text-red-50 font-medium focus:ring-offset-teal-800 py-[6px] px-5 rounded-xl bg-violet-700/20 focus:bg-blue-700/30 dark:placeholder:text-gray-400 placeholder:text-gray-600" value={search} onChange={e => setSearch(e.target.value)} placeholder='Search By Name...'/>
        </div>
        {!students &&
